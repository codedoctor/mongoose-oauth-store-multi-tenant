(function() {
  var Boom, Hoek, OauthAuthMethods, fnUnprocessableEntity, i18n, mongooseRestHelper, _,
  ...
  module.exports = OauthAuthMethods = (function() {
    ...
    OauthAuthMethods.prototype.appForClientId = function(clientId, options, cb) {
      ...
      if (!clientId) {
        return cb(fnUnprocessableEntity(i18n.errorClientIdRequired));
      }
    ...
    OauthAuthMethods.prototype.createAccessGrant = function(_tenantId, oauthAppId, userId, redirectUrl, scope, realm, options, cb) {
      ...
      if (!oauthAppId) {
        return cb(fnUnprocessableEntity(i18n.errorOauthAppIdRequired));
      }
      if (!userId) {
        return cb(fnUnprocessableEntity(i18n.errorUserIdRequired));
      }
      if (!redirectUrl) {
        return cb(fnUnprocessableEntity(i18n.errorRedirectUrlRequired));
      }
      if (!(scope && _.isArray(scope) && scope.length > 0)) {
        return cb(fnUnprocessableEntity(i18n.errorScopeRequiredAndArrayAndMinOne));
      }
    ...
    OauthAuthMethods.prototype.exchangeAuthorizationCodeForAccessToken = function(code, options, cb) {
      ...
      if (!refreshToken) {
        return cb(fnUnprocessableEntity(i18n.errorCodeRequired));
      }
      if (_.isFunction(options)) {
        cb = options;
        options = {};
    ...
    OauthAuthMethods.prototype.exchangeRefreshTokenForAccessToken = function(refreshToken, options, cb) {
      ...
      if (!refreshToken) {
        return cb(fnUnprocessableEntity(i18n.errorRefreshTokenRequired));
      }
      if (_.isFunction(options)) {
        cb = options;
        options = {};
